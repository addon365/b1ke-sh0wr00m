...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("addon365.Database.Entity.Inventory.Products.ExtraFittingsAccessories", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("addon365.Database.Entity.Inventory.Products.Product", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("Inventory.Products.Products");
                });

            modelBuilder.Entity("addon365.Database.Entity.Inventory.Products.ProductCompany", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("Inventory.Products.ProductsCompanies");
                });

            modelBuilder.Entity("addon365.Database.Entity.Inventory.Products.ProductPropertiesMap", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("Inventory.Products.ProductsPropertiesMaps");
                });

            modelBuilder.Entity("addon365.Database.Entity.Inventory.Products.ProductPropertyMaster", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("Inventory.Products.ProductsPropertiesMasters");
                });

            modelBuilder.Entity("addon365.Database.Entity.Inventory.Products.ProductType", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd();
                    ...
                    b.ToTable("Inventory.Products.ProductTypes");
                });
            ...
            modelBuilder.Entity("addon365.Database.Entity.Enquiries.EnquiryAccessories", b =>
                {
                    ...
                    b.HasOne("addon365.Database.Entity.Inventory.Products.Product", "product")
                        .WithMany()
            ...
            modelBuilder.Entity("addon365.Database.Entity.Inventory.Products.ExtraFittingsAccessories", b =>
                {
                    b.HasOne("addon365.Database.Entity.Inventory.Products.Product", "AccessoriesProductItem")
                        .WithMany()
            ...
            modelBuilder.Entity("addon365.Database.Entity.Inventory.Products.ProductPropertiesMap", b =>
                {
                    b.HasOne("addon365.Database.Entity.Inventory.Products.Product")
                        .WithMany("Properties")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade);

                    b.HasOne("addon365.Database.Entity.Inventory.Products.ProductPropertyMaster", "PropertyMaster")
                        .WithMany()
            ...
            modelBuilder.Entity("addon365.Database.Entity.Inventory.Purchases.PurchaseItemPropertyValue", b =>
                {
                    b.HasOne("addon365.Database.Entity.Inventory.Products.ProductPropertyMaster", "ProductPropertyMaster")
                        .WithMany()
                        .HasForeignKey("ProductPropertyMasterId")
                        .OnDelete(DeleteBehavior.Cascade);
