...
{
    public class ChitSubscriberDueReceiptDataService : IChitSubscriberDueReceiptDataService
    {
        private readonly IUnitOfWork _unitOfWork;
        public ChitSubscriberDueReceiptDataService(IUnitOfWork<DatabaseContext> unitOfWork)
        {
